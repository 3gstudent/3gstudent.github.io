...
在之前的文章[《Powershell tricks::Hide Process by kd.exe》](https://3gstudent.github.io/Powershell-tricks-Hide-Process-by-kd.exe/)介绍过通过kd.exe隐藏进程的技巧，最大的缺点是需要开启Local kernel debugging模式，等待重启才能生效
